...
namespace Etechflow\RichSnippets\Observer;
...
{
    private const PACKAGE     = 'etechflow/module-rich-snippets';
    private const LATEST_URL  = 'https://license-service.etechflow.com/composer/latest/etechflow/module-rich-snippets.json';
    private const CACHE_KEY   = 'etechflow_rs_update_check';
    private const CACHE_TTL   = 21600;
    private const MODULE_NAME = 'Etechflow_RichSnippets';
    ...
    public function execute(Observer $observer): void
    {
        try {
            ...
            $title = (string) __('eTechFlow Rich Snippets %1 is available', $latest['version']);
